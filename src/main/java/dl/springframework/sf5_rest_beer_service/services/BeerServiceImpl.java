...
import dl.springframework.sf5_rest_beer_service.web.controller.NotFoundException;
...
public class BeerServiceImpl implements BeerService {
    ...
    public BeerPagedList listBeers(String beerName, BeerStyleEnum beerStyle, PageRequest pageRequest, Boolean showInventoryOnHand) {
        System.out.println("ListBeers has been called without the cache");
    ...
    public BeerDto getById(UUID beerId, Boolean showInventoryOnHand) {
        System.out.println("getBeerById has been called without the cache");
        if (showInventoryOnHand) {
    ...
    public BeerDto getByUpc(String upc) {
        System.out.println("getBeerByUpc has been called without the cache");
            return beerMapper.beerToBeerDto(
